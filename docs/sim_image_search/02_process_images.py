...
flags.DEFINE_string('image_files', 'data/center_images/*.jpg', 'A glob path of images to process')
...
flags.DEFINE_string('output_folder', 'data/center_output', 'The folder where output files will be stored')
